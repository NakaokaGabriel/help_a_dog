...
/***/ "./assets/js/modules/animaMenu.js":
/*!****************************************!*\
  !*** ./assets/js/modules/animaMenu.js ***!
  \****************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return AnimaMenu; });\nclass AnimaMenu\r\n{\r\n    constructor(menu)\r\n    {\r\n        this.menu = document.querySelector(menu);\r\n    }\r\n    animaMenu(event)\r\n    {\r\n        if(event.currentTarget.pageYOffset > 10)\r\n        {\r\n            this.menu.classList.add('animaMenu');\r\n        }\r\n        else\r\n        {\r\n            this.menu.classList.remove('animaMenu');\r\n        }\r\n    }\r\n    eventScroll()\r\n    {\r\n        window.addEventListener('scroll', this.animaMenu);\r\n    }\r\n    init()\r\n    {\r\n        if (this.menu)\r\n        {\r\n            this.eventScroll();\r\n            return this;\r\n        }\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./assets/js/modules/animaMenu.js?");

/***/ }),

/***/ "./assets/js/modules/api-pagseguro.js":
/*!********************************************!*\
  !*** ./assets/js/modules/api-pagseguro.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return AtivaMenu; });\n/* harmony import */ var _outside_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./outside.js */ \"./assets/js/modules/outside.js\");\n\r\n\r\nclass AtivaMenu\r\n{\r\n    constructor (button, list)\r\n    {\r\n        this.button = document.querySelector(button);\r\n        this.list = document.querySelector(list);\r\n\r\n        this.activeMenu = this.activeMenu.bind(this);\r\n    }\r\n    \r\n    activeMenu(event)\r\n    {\r\n        const element = event.currentTarget;\r\n        this.list.classList.toggle('activeMenu');\r\n        element.classList.toggle('activeIcon');\r\n        Object(_outside_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(element, () => {\r\n            this.list.classList.remove('activeMenu');\r\n            element.classList.remove('activeIcon');\r\n        });\r\n    }\r\n\r\n    clickEvent()\r\n    {\r\n        this.button.addEventListener('click', this.activeMenu);\r\n    }\r\n\r\n    init()\r\n    {\r\n        if (this.list && this.button)\r\n        {\r\n            this.clickEvent();\r\n        }\r\n        return this; \r\n    }\r\n} \r\n\n\n//# sourceURL=webpack:///./assets/js/modules/ativaMenu.js?");

/***/ }),

/***/ "./assets/js/modules/fetch-adocao.js":
/*!*******************************************!*\
  !*** ./assets/js/modules/fetch-adocao.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return FetchContato; });\nclass FetchContato{\r\n    constructor(formulario, url)\r\n    {\r\n        this.formulario = document.querySelector(formulario);\r\n        this.url = url;\r\n        this.msg = document.querySelector('.msg-enviada');\r\n\r\n        this.fetchForm = this.fetchForm.bind(this);\r\n    }\r\n\r\n    // Previnir o padrão\r\n    // Colocar os valores do formulario com o objeto construtor form data\r\n    // Fazendo uma requisição promisse para enviar meus dados para o servidor em php\r\n    fetchForm(event)\r\n    {\r\n        event.preventDefault();\r\n        let dados = new FormData(this.formulario);\r\n        const metodos = {\r\n            method: 'POST',\r\n            body: dados\r\n        }\r\n        fetch(this.url, metodos)\r\n        .then((response) => response.json())\r\n        .then((body) => {            \r\n            if (body.Resposta === 'ok')\r\n            {\r\n                this.formulario.button.classList.add('loading-button');                        \r\n                this.formulario.button.setAttribute('disabled', '');                        \r\n                this.formulario.button.innerText = '';     \r\n                this.msg.innerText = '';\r\n            }\r\n            setTimeout(() => {\r\n                this.formulario.button.classList.remove('loading-button');\r\n                this.formulario.button.removeAttribute('disabled');   \r\n                this.formulario.button.innerText = 'ENVIAR';                        \r\n                this.formulario.reset();   \r\n                this.msg.innerText = 'Mensagem Enviada com sucesso.';\r\n                setTimeout(() => {\r\n                    this.msg.innerText = '';\r\n                }, 5000)\r\n            }, 3000);\r\n        })\r\n        .catch((error) => {\r\n            console.log(error);\r\n        })\r\n    }\r\n\r\n    // Evento de submit\r\n    eventFormSubmit()\r\n    {\r\n        this.formulario.addEventListener('submit', this.fetchForm);\r\n    }\r\n\r\n    init()\r\n    {\r\n        if(this.formulario && this.url && this.msg)\r\n        {\r\n            this.eventFormSubmit();\r\n        }\r\n        return this;\r\n    }\r\n\r\n} \n\n//# sourceURL=webpack:///./assets/js/modules/fetch-contato.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_animaMenu_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/animaMenu.js */ \"./assets/js/modules/animaMenu.js\");\n/* harmony import */ var _modules_scroll_suave_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/scroll-suave.js */ \"./assets/js/modules/scroll-suave.js\");\n/* harmony import */ var _modules_loading_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/loading.js */ \"./assets/js/modules/loading.js\");\n/* harmony import */ var _modules_mascara_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/mascara.js */ \"./assets/js/modules/mascara.js\");\n/* harmony import */ var _modules_ativaMenu_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/ativaMenu.js */ \"./assets/js/modules/ativaMenu.js\");\n/* harmony import */ var _modules_valida_forms_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/valida-forms.js */ \"./assets/js/modules/valida-forms.js\");\n/* harmony import */ var _modules_fetch_contato_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/fetch-contato.js */ \"./assets/js/modules/fetch-contato.js\");\n/* harmony import */ var _modules_fetch_adocao_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/fetch-adocao.js */ \"./assets/js/modules/fetch-adocao.js\");\n/* harmony import */ var _modules_valida_doacao_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/valida-doacao.js */ \"./assets/js/modules/valida-doacao.js\");\n/* harmony import */ var _modules_api_pagseguro_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/api-pagseguro.js */ \"./assets/js/modules/api-pagseguro.js\");\n/* harmony import */ var _modules_mascara_cartao_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/mascara-cartao.js */ \"./assets/js/modules/mascara-cartao.js\");\n// --------------------------------------------\r\n// Importações de classes que uso em todo o site\r\n// --------------------------------------------\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n// Evento de animação ao menu ao dar scroll\r\nconst scrollmenu = new _modules_animaMenu_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('[data-menu=\"mainMenu\"]');\r\nscrollmenu.init();\r\n\r\n// Evento de scroll mais suave ao clickar alguma tag com a\r\nconst scrollsuave = new _modules_scroll_suave_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('[data-animacao]', );\r\nscrollsuave.init();\r\n\r\n// Evento de carregamento de página\r\nconst loading = new _modules_loading_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"]('.loader', 'body');\r\nloading.init();\r\n\r\n// Mascara de telefone com todos os inputs que\r\n// possuirem o input com o id de telefone\r\nconst objectMask = new _modules_mascara_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"]('#telefone');\r\nobjectMask.init();\r\n\r\n// Evento para ativar animação do menu\r\nconst ativaMenu = new _modules_ativaMenu_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"]('[data-menu=\"button\"]', '[data-menu=\"list\"]');\r\nativaMenu.init();\r\n\r\n// Estilização de validação de formulario\r\nconst validaForms = new _modules_valida_forms_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"]('#contato');\r\nvalidaForms.init();\r\n\r\n// Envia formulario de contato sem refresh\r\nconst fetchContato = new _modules_fetch_contato_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"](\"#contato\", 'dev-contato.php');\r\nfetchContato.init();\r\n\r\n// Envia formulario de Adoção sem refresh\r\nconst fetchAdocao = new _modules_fetch_adocao_js__WEBPACK_IMPORTED_MODULE_7__[\"default\"](\"#adocao\", 'dev-adocao.php');\r\nfetchAdocao.init();\r\n\r\n// API do pag seguro\r\nObject(_modules_api_pagseguro_js__WEBPACK_IMPORTED_MODULE_9__[\"default\"])();\r\n\r\n// VALIDAÇÃO DOS CAMPOS DE DOAÇÃO\r\nObject(_modules_valida_doacao_js__WEBPACK_IMPORTED_MODULE_8__[\"default\"])();\r\n\r\n// Mascara cartao de credito\r\nconst cartMask = new _modules_mascara_cartao_js__WEBPACK_IMPORTED_MODULE_10__[\"default\"]('#cartao');\r\ncartMask.init();\n\n//# sourceURL=webpack:///./assets/js/style.js?");
...
/***/ 0:
/*!**************************************************!*\
  !*** multi @babel/polyfill ./assets/js/style.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./assets/js/style.js */\"./assets/js/style.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./assets/js/style.js?");
